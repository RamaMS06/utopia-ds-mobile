...
import 'screen_responsive_mixin.dart';
...
abstract class FontSizeResolvers {
  static double width(num fontSize, UTScreenResponsive instance) {
    return instance.setWidth(fontSize);
  }

  static double height(num fontSize, UTScreenResponsive instance) {
    return instance.setHeight(fontSize);
  }

  static double radius(num fontSize, UTScreenResponsive instance) {
    return instance.radius(fontSize);
  }

  static double diameter(num fontSize, UTScreenResponsive instance) {
    return instance.diameter(fontSize);
  }

  static double diagonal(num fontSize, UTScreenResponsive instance) {
    return instance.diagonal(fontSize);
  }
}

class UTScreenResponsiveInit extends StatefulWidget {
  /// A helper widget that initializes [UTScreenResponsive]
  const UTScreenResponsiveInit({
    super.key,
    this.builder,
    this.child,
    this.rebuildFactor = RebuildFactors.size,
    this.designSize = UTScreenResponsive.defaultSize,
  ...
  @override
  State<UTScreenResponsiveInit> createState() => _UTScreenResponsiveInitState();
}

class _UTScreenResponsiveInitState extends State<UTScreenResponsiveInit> with WidgetsBindingObserver {
  ...
  void initState() {
    ...
    UTScreenResponsive.enableScale(enableWH: widget.enableScaleWH, enableText: widget.enableScaleText);
  ...
  Future<void> _validateSize() async {
    if (widget.ensureScreenSize) return UTScreenResponsive.ensureScreenSize();
  }
