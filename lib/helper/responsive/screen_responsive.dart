...
typedef FontSizeResolver = double Function(
    num fontSize, UTScreenResponsive instance);

class UTScreenResponsive {
  static const Size defaultSize = Size(360, 690);
  static final UTScreenResponsive _instance = UTScreenResponsive._();
  ...
  UTScreenResponsive._();

  factory UTScreenResponsive() => _instance;
  ...
  static Future<void> ensureScreenSizeAndInit(
    ...
    return UTScreenResponsive.ensureScreenSize().then((_) {
      return init(
        context,
        designSize: designSize,
        minTextAdapt: minTextAdapt,
